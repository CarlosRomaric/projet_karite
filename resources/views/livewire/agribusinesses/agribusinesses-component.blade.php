        ...
        @include('livewire.agribusinesses.agribusinessmodal')
            ...
            <div class="flex flex-col sm:flex-row mt-2 w-full justify-between">
                ...
                <div class="mb-2 sm:mb-0 sm:flex-grow w-full sm:w-60 sm:order-1">
                 ...
                 <!-- Filtrer pa status -->
                 <!-- <div class="mb-2 sm:mb-0 sm:flex-grow w-full sm:w-60 sm:order-1">
                    <button class="btn-amber-karite  mt-2" >Choisir</button>
                    <select type="search" class="bg-amber-100 w-30 rounded-lg shadow px-4 py-2 mt-2" wire:model.change="statusFilter">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center mt-2 sm:mt-0 sm:order-2">
                    ...
                    <div class="flex flex-col sm:flex-row mt-2 sm:mt-0 sm:ml-2 w-full sm:w-auto">
                        ...
                        <!-- <button class="btn-amber-karite flex items-center w-full sm:w-auto mt-2 sm:mt-0 sm:ml-2 " data-te-toggle="modal" data-te-target="#agribusinessModal" data-te-ripple-init data-te-ripple-color="light" wire:click="create"> 
                        ...
                        <div class="overflow-hidden">
                            <table class="min-w-full text-left text-sm font-light my-10">
                                <thead class="bg-amber-800 bt-table">
                                    ...
                                    <th scope="col" class="rounded-tr-lg px-6 py-4 text-center">Action</th>
                                ...
                                <?php $i=0;?>
                                    ...
                                    <tr class="border-b border-t-2 border-amber-900 {{ $i % 2 !== 0 ? '' : 'bg-amber-100' }} dark:border-amber-900">
                                        ...
                                        <td class="whitespace-nowrap px-6 py-4">
                                            ...
                                            @elseif($agribusiness->status==1)
                                                <span class="bg-green-600 text-gray-100 rounded-full p-2 font-semibold">Valider</span>
                                            @else
                                                <span class="bg-red-600 text-gray-100 rounded-full p-2 font-semibold">Rejeter</span>
                                            @endif
                                        </td>


                                        <td class="whitespace-nowrap px-6 py-4">
                                            @if($agribusiness->matricule != 'MATIDP')
