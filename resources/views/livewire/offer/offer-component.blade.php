<div>
        <label for="" class="text-4xl font-bold">Liste des offres</label>
            ...
            <div class="overflow-x-auto  sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                    <div class="overflow-hidden">
                        <table class="min-w-full text-left text-sm font-light my-10">
                            <thead class="bg-amber-800 bt-table">
                                <tr class="">
                                    ...
                                    <th scope="col" class="px-6 py-4">Coopérative <br> Département</th>
                                    <th scope="col" class="px-6 py-4">Certification</th>
                                    <th scope="col" class="px-6 py-4">Poids (kg)</th>
                                    <th scope="col" class="px-6 py-4">Prix unitaire (FCFA)</th>
                                    <th scope="col" class="px-6 py-4">Prix Total (FCFA)</th>
                            ...
                            <?php $i=0;?>
                                ...
                                <tr class="border-b border-t-2 border-amber-800 {{ $i % 2 !== 0 ? '' : 'bg-amber-100' }} dark:border-amber-900">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">{{ $offer->qte }}  {{ $offer->type_packaging }}(s) </td>
                                    <td class="whitespace-nowrap px-6 py-4">-</td>
                                    
                                    <td class="whitespace-nowrap px-6 py-4">
                                        <button class="btn-success" wire:click='edit("{{$offer->id}}")' >
                                        ...
                                        <button class="btn-danger flex flex-row" wire:click='deleteForm("{{$offer->id}}")' >
                                            <svg width="15px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="livewire-pagination bg-green-100">{{ $offers->links('custom-pagination-links') }}</div>
